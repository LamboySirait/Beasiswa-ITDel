<div class="flex justify-end hidden md:flex md:w-auto md:order-1" id="mobile-menu-2">
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul class="flex flex-col  mt-4 border md:flex-row md:space-x-12 md:mt-0 md:text-sm md:font-medium md:border-0 me-10">
      ...
      <li>
        ...
        <div id="dropdownT" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
          <ul class="py-1 text-sm text-gray-700 " aria-labelledby="dropdownTulis">
            ...
            <li>
              <a href="{{ route('postsbeasiswainternal.create') }}" class="block py-2 px-4 hover:bg-gray-100 ">Beasiswa Internal</a>
            </li>
            <li>
              <a href="{{route('create-testimoni')}}" class="block py-2 px-4 hover:bg-gray-100 ">Testimoni</a>
            </li>
          </ul>
        </div>
      </li>
        ...
        <ul class="py-1" aria-labelledby="user-menu-button">
          ...
          <li>
            <form action="{{route('logout')}}" method="POST">
              @csrf
              <button type="submit" class="block pl-4 pr-24 py-2 text-sm text-gray-700 hover:bg-gray-100 ">Logout
              </button>
            </form>
          </li>
        </ul>
