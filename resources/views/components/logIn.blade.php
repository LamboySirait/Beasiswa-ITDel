<div class="flex justify-end hidden md:flex md:w-auto md:order-1" id="mobile-menu-2">
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul class="flex flex-col  mt-4 border md:flex-row md:space-x-12 md:mt-0 md:text-sm md:font-medium md:border-0 me-10">
      ...
      <li>
        <a href="/about" class="block py-2 pl-3 pr-4 text-primary rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-400 md:p-0 tracking-wider" aria-current="page">TENTANG KAMI</a>
      </li>
    </ul>
    <button class="bg-[#0D285F] px-4 py-1 hover:bg-[#041538] hover:text-white shadow-lg text-white rounded-md" >
