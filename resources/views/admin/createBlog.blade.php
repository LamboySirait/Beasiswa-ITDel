  ...
  <div class="w-3/4 mx-auto font-montserrat font-medium">
    ...
    <form action="{{ route('store-blog') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-10">
        ...
        <input class="block w-full px-4 py-3 text-gray-700 border border-gray-300 rounded leading-tight focus:outline-none hover:shadow-md" type="file" id="thumbnail" name="thumbnail" accept="image/*">
        @error('caption')
        <div class="text-red-600  pl-2">{{ $message }}</div>
        @enderror
      </div>
      ...
      @if($type=="Beasiswa")
      <div class="mb-10">
        <label class="text-xl p-1 tracking-wide" for="title">Link Beasiswa</label>
